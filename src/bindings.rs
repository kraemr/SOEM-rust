...
pub const EC_MBXPOOLSIZE: u32 = 32;
...
pub const EC_MBXQUEUESTATE_NONE: u32 = 0;
pub const EC_MBXQUEUESTATE_REQ: u32 = 1;
pub const EC_MBXQUEUESTATE_FAIL: u32 = 2;
pub const EC_MBXQUEUESTATE_DONE: u32 = 3;
...
pub const ECT_MBXH_NONE: u32 = 0;
pub const ECT_MBXH_CYCLIC: u32 = 1;
pub const ECT_MBXH_LOST: u32 = 2;
pub const ECT_ESMTRANS_IP: u32 = 1;
pub const ECT_ESMTRANS_PS: u32 = 2;
pub const ECT_ESMTRANS_PI: u32 = 4;
pub const ECT_ESMTRANS_SP: u32 = 8;
pub const ECT_ESMTRANS_SO: u32 = 16;
pub const ECT_ESMTRANS_SI: u32 = 32;
pub const ECT_ESMTRANS_OS: u32 = 64;
pub const ECT_ESMTRANS_OP: u32 = 128;
pub const ECT_ESMTRANS_OI: u32 = 256;
pub const ECT_ESMTRANS_IB: u32 = 512;
pub const ECT_ESMTRANS_BI: u32 = 1024;
pub const ECT_ESMTRANS_II: u32 = 2048;
pub const ECT_ESMTRANS_PP: u32 = 4096;
pub const ECT_ESMTRANS_SS: u32 = 8192;
...
pub struct osal_timer {
    pub stop_time: timespec,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of osal_timer"][::std::mem::size_of::<osal_timer>() - 16usize];
    ["Alignment of osal_timer"][::std::mem::align_of::<osal_timer>() - 8usize];
    ["Offset of field: osal_timer::stop_time"]
        [::std::mem::offset_of!(osal_timer, stop_time) - 0usize];
};
pub type osal_timert = osal_timer;
unsafe extern "C" {
    #[doc = " @brief Returns monotonic time from some unspecified moment in the\n past.\n\n This time must be strictly increasing. It is used for time\n intervals measurement.\n\n @param ts Pointer to an ec_timet structure where the time will be\n stored."]
    pub fn osal_get_monotonic_time(ts: *mut timespec);
}
unsafe extern "C" {
    #[doc = " @brief Returns the current time.\n\n This time is used to set the initial EtherCAT network DC time and\n for logging purposes.\n\n @return ec_timet containing the current time."]
    pub fn osal_current_time() -> timespec;
}
unsafe extern "C" {
    #[doc = " @brief Calculates the difference between two timestamps.\n\n @param start Pointer to the start timestamp.\n @param end Pointer to the end timestamp.\n @param diff Pointer to an ec_timet structure where the difference\n will be stored."]
    pub fn osal_time_diff(start: *mut timespec, end: *mut timespec, diff: *mut timespec);
}
unsafe extern "C" {
    #[doc = " @brief Starts the timer with a specified timeout.\n\n @param self Pointer to the timer object.\n @param timeout_usec Timeout in microseconds."]
    pub fn osal_timer_start(self_: *mut osal_timert, timeout_usec: uint32);
}
unsafe extern "C" {
    #[doc = " @brief Checks if the timer has expired.\n\n @param self Pointer to the timer object.\n @return True if the timer is expired, false otherwise."]
    pub fn osal_timer_is_expired(self_: *mut osal_timert) -> boolean;
}
unsafe extern "C" {
    #[doc = " @brief Sleeps for a specified duration in microseconds.\n\n @param usec Duration in microseconds.\n @return 0 on success, -1 on failure."]
    pub fn osal_usleep(usec: uint32) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Sleeps until the specified monotonic time.\n\n @param ts Pointer to an ec_timet structure representing the\n absolute time to sleep until.\n @return 0 on success, -1 on failure."]
    pub fn osal_monotonic_sleep(ts: *mut timespec) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " @brief Allocates memory of the specified size.\n\n @param size Size in bytes to allocate.\n @return Pointer to the allocated memory or NULL on failure."]
    pub fn osal_malloc(size: usize) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    #[doc = " @brief Frees the allocated memory.\n\n @param ptr Pointer to the memory to free."]
    pub fn osal_free(ptr: *mut ::std::os::raw::c_void);
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " @brief Creates a new real-time thread.\n\n @param thandle Pointer to the thread handle which will store the\n thread ID.\n @param stacksize Size of the stack for the new thread.\n @param func Pointer to the function to execute in the new thread.\n @param param Pointer to parameters to pass to the thread function.\n @return 1 on success, 0 on failure."]
...
unsafe extern "C" {
    ...
    pub fn osal_mutex_create() -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    #[doc = " @brief Destroys a mutex.\n\n @param mutex Pointer to the mutex to destroy."]
    pub fn osal_mutex_destroy(mutex: *mut ::std::os::raw::c_void);
}
unsafe extern "C" {
    #[doc = " @brief Locks the mutex.\n\n @param mutex Pointer to the mutex to lock."]
    pub fn osal_mutex_lock(mutex: *mut ::std::os::raw::c_void);
}
unsafe extern "C" {
    #[doc = " @brief Unlocks the mutex.\n\n @param mutex Pointer to the mutex to unlock."]
    pub fn osal_mutex_unlock(mutex: *mut ::std::os::raw::c_void);
}
...
pub const ECT_SII_SER: _bindgen_ty_12 = 14;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_errort"][::std::mem::size_of::<ec_errort>() - 40usize];
    ["Alignment of ec_errort"][::std::mem::align_of::<ec_errort>() - 8usize];
    ["Offset of field: ec_errort::Time"][::std::mem::offset_of!(ec_errort, Time) - 0usize];
    ["Offset of field: ec_errort::Signal"][::std::mem::offset_of!(ec_errort, Signal) - 16usize];
    ["Offset of field: ec_errort::Slave"][::std::mem::offset_of!(ec_errort, Slave) - 18usize];
    ["Offset of field: ec_errort::Index"][::std::mem::offset_of!(ec_errort, Index) - 20usize];
    ["Offset of field: ec_errort::SubIdx"][::std::mem::offset_of!(ec_errort, SubIdx) - 22usize];
    ["Offset of field: ec_errort::Etype"][::std::mem::offset_of!(ec_errort, Etype) - 24usize];
};
...
pub struct ec_stackT {
    ...
    #[doc = " number of received frames"]
    pub rxcnt: uint64,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_stackT"][::std::mem::size_of::<ec_stackT>() - 64usize];
    ...
    ["Offset of field: ec_stackT::rxcnt"][::std::mem::offset_of!(ec_stackT, rxcnt) - 56usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ecx_redportt"][::std::mem::size_of::<ecx_redportt>() - 26008usize];
    ...
    ["Offset of field: ecx_redportt::sockhandle"]
        [::std::mem::offset_of!(ecx_redportt, sockhandle) - 64usize];
    ["Offset of field: ecx_redportt::rxbuf"][::std::mem::offset_of!(ecx_redportt, rxbuf) - 68usize];
    ["Offset of field: ecx_redportt::rxbufstat"]
        [::std::mem::offset_of!(ecx_redportt, rxbufstat) - 24356usize];
    ["Offset of field: ecx_redportt::rxsa"]
        [::std::mem::offset_of!(ecx_redportt, rxsa) - 24420usize];
    ["Offset of field: ecx_redportt::tempinbuf"]
        [::std::mem::offset_of!(ecx_redportt, tempinbuf) - 24484usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ecx_portt"][::std::mem::size_of::<ecx_portt>() - 52024usize];
    ...
    ["Offset of field: ecx_portt::sockhandle"]
        [::std::mem::offset_of!(ecx_portt, sockhandle) - 64usize];
    ["Offset of field: ecx_portt::rxbuf"][::std::mem::offset_of!(ecx_portt, rxbuf) - 68usize];
    ["Offset of field: ecx_portt::rxbufstat"]
        [::std::mem::offset_of!(ecx_portt, rxbufstat) - 24356usize];
    ["Offset of field: ecx_portt::rxsa"][::std::mem::offset_of!(ecx_portt, rxsa) - 24420usize];
    ["Offset of field: ecx_portt::tempinbuf"]
        [::std::mem::offset_of!(ecx_portt, tempinbuf) - 24484usize];
    ["Offset of field: ecx_portt::tempinbufs"]
        [::std::mem::offset_of!(ecx_portt, tempinbufs) - 26004usize];
    ["Offset of field: ecx_portt::txbuf"][::std::mem::offset_of!(ecx_portt, txbuf) - 26008usize];
    ["Offset of field: ecx_portt::txbuflength"]
        [::std::mem::offset_of!(ecx_portt, txbuflength) - 50296usize];
    ["Offset of field: ecx_portt::txbuf2"][::std::mem::offset_of!(ecx_portt, txbuf2) - 50360usize];
    ["Offset of field: ecx_portt::txbuflength2"]
        [::std::mem::offset_of!(ecx_portt, txbuflength2) - 51880usize];
    ["Offset of field: ecx_portt::lastidx"]
        [::std::mem::offset_of!(ecx_portt, lastidx) - 51884usize];
    ["Offset of field: ecx_portt::redstate"]
        [::std::mem::offset_of!(ecx_portt, redstate) - 51888usize];
    ["Offset of field: ecx_portt::redport"]
        [::std::mem::offset_of!(ecx_portt, redport) - 51896usize];
    ["Offset of field: ecx_portt::getindex_mutex"]
        [::std::mem::offset_of!(ecx_portt, getindex_mutex) - 51904usize];
    ["Offset of field: ecx_portt::tx_mutex"]
        [::std::mem::offset_of!(ecx_portt, tx_mutex) - 51944usize];
    ["Offset of field: ecx_portt::rx_mutex"]
        [::std::mem::offset_of!(ecx_portt, rx_mutex) - 51984usize];
};
unsafe extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ec_mbxpoolt {
    pub listhead: ::std::os::raw::c_int,
    pub listtail: ::std::os::raw::c_int,
    pub listcount: ::std::os::raw::c_int,
    pub mbxemptylist: [::std::os::raw::c_int; 32usize],
    pub mbxmutex: *mut pthread_mutex_t,
    pub mbx: [ec_mbxbuft; 32usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_mbxpoolt"][::std::mem::size_of::<ec_mbxpoolt>() - 47736usize];
    ["Alignment of ec_mbxpoolt"][::std::mem::align_of::<ec_mbxpoolt>() - 8usize];
    ["Offset of field: ec_mbxpoolt::listhead"]
        [::std::mem::offset_of!(ec_mbxpoolt, listhead) - 0usize];
    ["Offset of field: ec_mbxpoolt::listtail"]
        [::std::mem::offset_of!(ec_mbxpoolt, listtail) - 4usize];
    ["Offset of field: ec_mbxpoolt::listcount"]
        [::std::mem::offset_of!(ec_mbxpoolt, listcount) - 8usize];
    ["Offset of field: ec_mbxpoolt::mbxemptylist"]
        [::std::mem::offset_of!(ec_mbxpoolt, mbxemptylist) - 12usize];
    ["Offset of field: ec_mbxpoolt::mbxmutex"]
        [::std::mem::offset_of!(ec_mbxpoolt, mbxmutex) - 144usize];
    ["Offset of field: ec_mbxpoolt::mbx"][::std::mem::offset_of!(ec_mbxpoolt, mbx) - 152usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ec_mbxqueuet {
    pub listhead: ::std::os::raw::c_int,
    pub listtail: ::std::os::raw::c_int,
    pub listcount: ::std::os::raw::c_int,
    pub mbx: [*mut ec_mbxbuft; 32usize],
    pub mbxstate: [::std::os::raw::c_int; 32usize],
    pub mbxremove: [::std::os::raw::c_int; 32usize],
    pub mbxticket: [::std::os::raw::c_int; 32usize],
    pub mbxslave: [uint16; 32usize],
    pub mbxmutex: *mut pthread_mutex_t,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_mbxqueuet"][::std::mem::size_of::<ec_mbxqueuet>() - 728usize];
    ["Alignment of ec_mbxqueuet"][::std::mem::align_of::<ec_mbxqueuet>() - 8usize];
    ["Offset of field: ec_mbxqueuet::listhead"]
        [::std::mem::offset_of!(ec_mbxqueuet, listhead) - 0usize];
    ["Offset of field: ec_mbxqueuet::listtail"]
        [::std::mem::offset_of!(ec_mbxqueuet, listtail) - 4usize];
    ["Offset of field: ec_mbxqueuet::listcount"]
        [::std::mem::offset_of!(ec_mbxqueuet, listcount) - 8usize];
    ["Offset of field: ec_mbxqueuet::mbx"][::std::mem::offset_of!(ec_mbxqueuet, mbx) - 16usize];
    ["Offset of field: ec_mbxqueuet::mbxstate"]
        [::std::mem::offset_of!(ec_mbxqueuet, mbxstate) - 272usize];
    ["Offset of field: ec_mbxqueuet::mbxremove"]
        [::std::mem::offset_of!(ec_mbxqueuet, mbxremove) - 400usize];
    ["Offset of field: ec_mbxqueuet::mbxticket"]
        [::std::mem::offset_of!(ec_mbxqueuet, mbxticket) - 528usize];
    ["Offset of field: ec_mbxqueuet::mbxslave"]
        [::std::mem::offset_of!(ec_mbxqueuet, mbxslave) - 656usize];
    ["Offset of field: ec_mbxqueuet::mbxmutex"]
        [::std::mem::offset_of!(ec_mbxqueuet, mbxmutex) - 720usize];
};
...
pub struct ec_slave {
    ...
    #[doc = " output offset in IOmap buffer"]
    pub Ooffset: uint32,
    ...
    #[doc = " input offset in IOmap buffer"]
    pub Ioffset: uint32,
    ...
    #[doc = " FMMU0 function 0=unused 1=outputs 2=inputs 3=SM status"]
    pub FMMU0func: uint8,
    #[doc = " FMMU1 function"]
    pub FMMU1func: uint8,
    #[doc = " FMMU2 function"]
    ...
    pub PO2SOconfig: ::std::option::Option<
        unsafe extern "C" fn(context: *mut ecx_contextt, slave: uint16) -> ::std::os::raw::c_int,
    >,
    #[doc = " mailbox handler state, 0 = no handler, 1 = cyclic task mbx handler, 2 = slave lost"]
    pub mbxhandlerstate: ::std::os::raw::c_int,
    #[doc = " mailbox handler robust mailbox protocol state"]
    pub mbxrmpstate: ::std::os::raw::c_int,
    #[doc = " mailbox handler RMP extended mbx in state"]
    pub mbxinstateex: uint16,
    #[doc = " pointer to CoE mailbox in buffer"]
    pub coembxin: *mut uint8,
    #[doc = " CoE mailbox in flag, true = mailbox full"]
    pub coembxinfull: boolean,
    #[doc = " CoE mailbox in overrun counter"]
    pub coembxoverrun: ::std::os::raw::c_int,
    #[doc = " pointer to SoE mailbox in buffer"]
    pub soembxin: *mut uint8,
    #[doc = " SoE mailbox in flag, true = mailbox full"]
    pub soembxinfull: boolean,
    #[doc = " SoE mailbox in overrun counter"]
    pub soembxoverrun: ::std::os::raw::c_int,
    #[doc = " pointer to FoE mailbox in buffer"]
    pub foembxin: *mut uint8,
    #[doc = " FoE mailbox in flag, true = mailbox full"]
    pub foembxinfull: boolean,
    #[doc = " FoE mailbox in overrun counter"]
    pub foembxoverrun: ::std::os::raw::c_int,
    #[doc = " pointer to EoE mailbox in buffer"]
    pub eoembxin: *mut uint8,
    #[doc = " EoE mailbox in flag, true = mailbox full"]
    pub eoembxinfull: boolean,
    #[doc = " EoE mailbox in overrun counter"]
    pub eoembxoverrun: ::std::os::raw::c_int,
    #[doc = " pointer to VoE mailbox in buffer"]
    pub voembxin: *mut uint8,
    #[doc = " VoE mailbox in flag, true = mailbox full"]
    pub voembxinfull: boolean,
    #[doc = " VoE mailbox in overrun counter"]
    pub voembxoverrun: ::std::os::raw::c_int,
    #[doc = " pointer to AoE mailbox in buffer"]
    pub aoembxin: *mut uint8,
    #[doc = " AoE mailbox in flag, true = mailbox full"]
    pub aoembxinfull: boolean,
    #[doc = " AoE mailbox in overrun counter"]
    pub aoembxoverrun: ::std::os::raw::c_int,
    #[doc = " pointer to out mailbox status register buffer"]
    pub mbxstatus: *mut uint8,
    #[doc = " readable name"]
    pub name: [::std::os::raw::c_char; 41usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_slave"][::std::mem::size_of::<ec_slave>() - 464usize];
    ...
    ["Offset of field: ec_slave::eep_ser"][::std::mem::offset_of!(ec_slave, eep_ser) - 20usize];
    ...
    ["Offset of field: ec_slave::Ooffset"][::std::mem::offset_of!(ec_slave, Ooffset) - 48usize];
    ["Offset of field: ec_slave::Ostartbit"][::std::mem::offset_of!(ec_slave, Ostartbit) - 52usize];
    ["Offset of field: ec_slave::Ibits"][::std::mem::offset_of!(ec_slave, Ibits) - 54usize];
    ["Offset of field: ec_slave::Ibytes"][::std::mem::offset_of!(ec_slave, Ibytes) - 56usize];
    ["Offset of field: ec_slave::inputs"][::std::mem::offset_of!(ec_slave, inputs) - 64usize];
    ["Offset of field: ec_slave::Ioffset"][::std::mem::offset_of!(ec_slave, Ioffset) - 72usize];
    ["Offset of field: ec_slave::Istartbit"][::std::mem::offset_of!(ec_slave, Istartbit) - 76usize];
    ["Offset of field: ec_slave::SM"][::std::mem::offset_of!(ec_slave, SM) - 77usize];
    ["Offset of field: ec_slave::SMtype"][::std::mem::offset_of!(ec_slave, SMtype) - 141usize];
    ["Offset of field: ec_slave::FMMU"][::std::mem::offset_of!(ec_slave, FMMU) - 149usize];
    ["Offset of field: ec_slave::FMMU0func"]
        [::std::mem::offset_of!(ec_slave, FMMU0func) - 213usize];
    ["Offset of field: ec_slave::FMMU1func"]
        [::std::mem::offset_of!(ec_slave, FMMU1func) - 214usize];
    ["Offset of field: ec_slave::FMMU2func"]
        [::std::mem::offset_of!(ec_slave, FMMU2func) - 215usize];
    ["Offset of field: ec_slave::FMMU3func"]
        [::std::mem::offset_of!(ec_slave, FMMU3func) - 216usize];
    ["Offset of field: ec_slave::mbx_l"][::std::mem::offset_of!(ec_slave, mbx_l) - 218usize];
    ["Offset of field: ec_slave::mbx_wo"][::std::mem::offset_of!(ec_slave, mbx_wo) - 220usize];
    ["Offset of field: ec_slave::mbx_rl"][::std::mem::offset_of!(ec_slave, mbx_rl) - 222usize];
    ["Offset of field: ec_slave::mbx_ro"][::std::mem::offset_of!(ec_slave, mbx_ro) - 224usize];
    ["Offset of field: ec_slave::mbx_proto"]
        [::std::mem::offset_of!(ec_slave, mbx_proto) - 226usize];
    ["Offset of field: ec_slave::mbx_cnt"][::std::mem::offset_of!(ec_slave, mbx_cnt) - 228usize];
    ["Offset of field: ec_slave::hasdc"][::std::mem::offset_of!(ec_slave, hasdc) - 229usize];
    ["Offset of field: ec_slave::ptype"][::std::mem::offset_of!(ec_slave, ptype) - 230usize];
    ["Offset of field: ec_slave::topology"][::std::mem::offset_of!(ec_slave, topology) - 231usize];
    ["Offset of field: ec_slave::activeports"]
        [::std::mem::offset_of!(ec_slave, activeports) - 232usize];
    ["Offset of field: ec_slave::consumedports"]
        [::std::mem::offset_of!(ec_slave, consumedports) - 233usize];
    ["Offset of field: ec_slave::parent"][::std::mem::offset_of!(ec_slave, parent) - 234usize];
    ["Offset of field: ec_slave::parentport"]
        [::std::mem::offset_of!(ec_slave, parentport) - 236usize];
    ["Offset of field: ec_slave::entryport"]
        [::std::mem::offset_of!(ec_slave, entryport) - 237usize];
    ["Offset of field: ec_slave::DCrtA"][::std::mem::offset_of!(ec_slave, DCrtA) - 240usize];
    ["Offset of field: ec_slave::DCrtB"][::std::mem::offset_of!(ec_slave, DCrtB) - 244usize];
    ["Offset of field: ec_slave::DCrtC"][::std::mem::offset_of!(ec_slave, DCrtC) - 248usize];
    ["Offset of field: ec_slave::DCrtD"][::std::mem::offset_of!(ec_slave, DCrtD) - 252usize];
    ["Offset of field: ec_slave::pdelay"][::std::mem::offset_of!(ec_slave, pdelay) - 256usize];
    ["Offset of field: ec_slave::DCnext"][::std::mem::offset_of!(ec_slave, DCnext) - 260usize];
    ["Offset of field: ec_slave::DCprevious"]
        [::std::mem::offset_of!(ec_slave, DCprevious) - 262usize];
    ["Offset of field: ec_slave::DCcycle"][::std::mem::offset_of!(ec_slave, DCcycle) - 264usize];
    ["Offset of field: ec_slave::DCshift"][::std::mem::offset_of!(ec_slave, DCshift) - 268usize];
    ["Offset of field: ec_slave::DCactive"][::std::mem::offset_of!(ec_slave, DCactive) - 272usize];
    ["Offset of field: ec_slave::SIIindex"][::std::mem::offset_of!(ec_slave, SIIindex) - 274usize];
    ["Offset of field: ec_slave::eep_8byte"]
        [::std::mem::offset_of!(ec_slave, eep_8byte) - 276usize];
    ["Offset of field: ec_slave::eep_pdi"][::std::mem::offset_of!(ec_slave, eep_pdi) - 277usize];
    ["Offset of field: ec_slave::CoEdetails"]
        [::std::mem::offset_of!(ec_slave, CoEdetails) - 278usize];
    ["Offset of field: ec_slave::FoEdetails"]
        [::std::mem::offset_of!(ec_slave, FoEdetails) - 279usize];
    ["Offset of field: ec_slave::EoEdetails"]
        [::std::mem::offset_of!(ec_slave, EoEdetails) - 280usize];
    ["Offset of field: ec_slave::SoEdetails"]
        [::std::mem::offset_of!(ec_slave, SoEdetails) - 281usize];
    ["Offset of field: ec_slave::Ebuscurrent"]
        [::std::mem::offset_of!(ec_slave, Ebuscurrent) - 282usize];
    ["Offset of field: ec_slave::blockLRW"][::std::mem::offset_of!(ec_slave, blockLRW) - 284usize];
    ["Offset of field: ec_slave::group"][::std::mem::offset_of!(ec_slave, group) - 285usize];
    ["Offset of field: ec_slave::FMMUunused"]
        [::std::mem::offset_of!(ec_slave, FMMUunused) - 286usize];
    ["Offset of field: ec_slave::islost"][::std::mem::offset_of!(ec_slave, islost) - 287usize];
    ["Offset of field: ec_slave::PO2SOconfig"]
        [::std::mem::offset_of!(ec_slave, PO2SOconfig) - 288usize];
    ["Offset of field: ec_slave::mbxhandlerstate"]
        [::std::mem::offset_of!(ec_slave, mbxhandlerstate) - 296usize];
    ["Offset of field: ec_slave::mbxrmpstate"]
        [::std::mem::offset_of!(ec_slave, mbxrmpstate) - 300usize];
    ["Offset of field: ec_slave::mbxinstateex"]
        [::std::mem::offset_of!(ec_slave, mbxinstateex) - 304usize];
    ["Offset of field: ec_slave::coembxin"][::std::mem::offset_of!(ec_slave, coembxin) - 312usize];
    ["Offset of field: ec_slave::coembxinfull"]
        [::std::mem::offset_of!(ec_slave, coembxinfull) - 320usize];
    ["Offset of field: ec_slave::coembxoverrun"]
        [::std::mem::offset_of!(ec_slave, coembxoverrun) - 324usize];
    ["Offset of field: ec_slave::soembxin"][::std::mem::offset_of!(ec_slave, soembxin) - 328usize];
    ["Offset of field: ec_slave::soembxinfull"]
        [::std::mem::offset_of!(ec_slave, soembxinfull) - 336usize];
    ["Offset of field: ec_slave::soembxoverrun"]
        [::std::mem::offset_of!(ec_slave, soembxoverrun) - 340usize];
    ["Offset of field: ec_slave::foembxin"][::std::mem::offset_of!(ec_slave, foembxin) - 344usize];
    ["Offset of field: ec_slave::foembxinfull"]
        [::std::mem::offset_of!(ec_slave, foembxinfull) - 352usize];
    ["Offset of field: ec_slave::foembxoverrun"]
        [::std::mem::offset_of!(ec_slave, foembxoverrun) - 356usize];
    ["Offset of field: ec_slave::eoembxin"][::std::mem::offset_of!(ec_slave, eoembxin) - 360usize];
    ["Offset of field: ec_slave::eoembxinfull"]
        [::std::mem::offset_of!(ec_slave, eoembxinfull) - 368usize];
    ["Offset of field: ec_slave::eoembxoverrun"]
        [::std::mem::offset_of!(ec_slave, eoembxoverrun) - 372usize];
    ["Offset of field: ec_slave::voembxin"][::std::mem::offset_of!(ec_slave, voembxin) - 376usize];
    ["Offset of field: ec_slave::voembxinfull"]
        [::std::mem::offset_of!(ec_slave, voembxinfull) - 384usize];
    ["Offset of field: ec_slave::voembxoverrun"]
        [::std::mem::offset_of!(ec_slave, voembxoverrun) - 388usize];
    ["Offset of field: ec_slave::aoembxin"][::std::mem::offset_of!(ec_slave, aoembxin) - 392usize];
    ["Offset of field: ec_slave::aoembxinfull"]
        [::std::mem::offset_of!(ec_slave, aoembxinfull) - 400usize];
    ["Offset of field: ec_slave::aoembxoverrun"]
        [::std::mem::offset_of!(ec_slave, aoembxoverrun) - 404usize];
    ["Offset of field: ec_slave::mbxstatus"]
        [::std::mem::offset_of!(ec_slave, mbxstatus) - 408usize];
    ["Offset of field: ec_slave::name"][::std::mem::offset_of!(ec_slave, name) - 416usize];
};
#[doc = " Slave state\n All slave information is put in this structure. Needed for most\n user interaction with slaves."]
...
pub struct ec_group {
    ...
    #[doc = " pointer to out mailbox status register buffer"]
    pub mbxstatus: *mut uint8,
    #[doc = " mailbox status register buffer length"]
    pub mbxstatuslength: int32,
    #[doc = " mailbox status lookup table"]
    pub mbxstatuslookup: [uint16; 200usize],
    #[doc = " mailbox last handled in mxbhandler"]
    pub lastmbxpos: uint16,
    #[doc = " mailbox  transmit queue struct"]
    pub mbxtxqueue: ec_mbxqueuet,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_group"][::std::mem::size_of::<ec_group>() - 1456usize];
    ...
    ["Offset of field: ec_group::mbxstatus"]
        [::std::mem::offset_of!(ec_group, mbxstatus) - 312usize];
    ["Offset of field: ec_group::mbxstatuslength"]
        [::std::mem::offset_of!(ec_group, mbxstatuslength) - 320usize];
    ["Offset of field: ec_group::mbxstatuslookup"]
        [::std::mem::offset_of!(ec_group, mbxstatuslookup) - 324usize];
    ["Offset of field: ec_group::lastmbxpos"]
        [::std::mem::offset_of!(ec_group, lastmbxpos) - 724usize];
    ["Offset of field: ec_group::mbxtxqueue"]
        [::std::mem::offset_of!(ec_group, mbxtxqueue) - 728usize];
};
#[doc = " for list of ethercat slave groups"]
pub type ec_groupt = ec_group;
#[doc = " ENI CoE command structure"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ec_enicoecmd {
    #[doc = " transition(s) during which command should be sent"]
    pub Transition: uint16,
    #[doc = " complete access flag"]
    pub CA: boolean,
    #[doc = " ccs (1 = read, 2 = write)"]
    pub Ccs: uint8,
    #[doc = " object index"]
    pub Index: uint16,
    #[doc = " object subindex"]
    ...
    #[doc = " size in bytes of parameter buffer"]
    pub DataSize: ::std::os::raw::c_int,
    #[doc = " pointer to parameter buffer"]
    pub Data: *mut ::std::os::raw::c_void,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_enicoecmd"][::std::mem::size_of::<ec_enicoecmd>() - 24usize];
    ["Alignment of ec_enicoecmd"][::std::mem::align_of::<ec_enicoecmd>() - 8usize];
    ["Offset of field: ec_enicoecmd::Transition"]
        [::std::mem::offset_of!(ec_enicoecmd, Transition) - 0usize];
    ["Offset of field: ec_enicoecmd::CA"][::std::mem::offset_of!(ec_enicoecmd, CA) - 2usize];
    ["Offset of field: ec_enicoecmd::Ccs"][::std::mem::offset_of!(ec_enicoecmd, Ccs) - 3usize];
    ["Offset of field: ec_enicoecmd::Index"][::std::mem::offset_of!(ec_enicoecmd, Index) - 4usize];
    ["Offset of field: ec_enicoecmd::SubIdx"]
        [::std::mem::offset_of!(ec_enicoecmd, SubIdx) - 6usize];
    ["Offset of field: ec_enicoecmd::Timeout"]
        [::std::mem::offset_of!(ec_enicoecmd, Timeout) - 8usize];
    ["Offset of field: ec_enicoecmd::DataSize"]
        [::std::mem::offset_of!(ec_enicoecmd, DataSize) - 12usize];
    ["Offset of field: ec_enicoecmd::Data"][::std::mem::offset_of!(ec_enicoecmd, Data) - 16usize];
};
#[doc = " ENI CoE command structure"]
pub type ec_enicoecmdt = ec_enicoecmd;
#[doc = " ENI slave structure"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ec_enislave {
    pub Slave: uint16,
    pub VendorId: uint32,
    pub ProductCode: uint32,
    pub RevisionNo: uint32,
    pub CoECmds: *mut ec_enicoecmdt,
    pub CoECmdCount: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_enislave"][::std::mem::size_of::<ec_enislave>() - 32usize];
    ["Alignment of ec_enislave"][::std::mem::align_of::<ec_enislave>() - 8usize];
    ["Offset of field: ec_enislave::Slave"][::std::mem::offset_of!(ec_enislave, Slave) - 0usize];
    ["Offset of field: ec_enislave::VendorId"]
        [::std::mem::offset_of!(ec_enislave, VendorId) - 4usize];
    ["Offset of field: ec_enislave::ProductCode"]
        [::std::mem::offset_of!(ec_enislave, ProductCode) - 8usize];
    ["Offset of field: ec_enislave::RevisionNo"]
        [::std::mem::offset_of!(ec_enislave, RevisionNo) - 12usize];
    ["Offset of field: ec_enislave::CoECmds"]
        [::std::mem::offset_of!(ec_enislave, CoECmds) - 16usize];
    ["Offset of field: ec_enislave::CoECmdCount"]
        [::std::mem::offset_of!(ec_enislave, CoECmdCount) - 24usize];
};
#[doc = " ENI slave structure"]
pub type ec_enislavet = ec_enislave;
#[doc = " ENI structure"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ec_eni {
    pub slave: *mut ec_enislavet,
    pub slavecount: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_eni"][::std::mem::size_of::<ec_eni>() - 16usize];
    ["Alignment of ec_eni"][::std::mem::align_of::<ec_eni>() - 8usize];
    ["Offset of field: ec_eni::slave"][::std::mem::offset_of!(ec_eni, slave) - 0usize];
    ["Offset of field: ec_eni::slavecount"][::std::mem::offset_of!(ec_eni, slavecount) - 8usize];
};
#[doc = " ENI structure"]
pub type ec_enit = ec_eni;
...
pub struct ec_idxstack {
    ...
    pub type_: [uint8; 16usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_idxstack"][::std::mem::size_of::<ec_idxstack>() - 232usize];
    ...
    ["Offset of field: ec_idxstack::type_"][::std::mem::offset_of!(ec_idxstack, type_) - 216usize];
};
#[doc = " stack structure to store segmented LRD/LWR/LRW constructs"]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ec_ering"][::std::mem::size_of::<ec_ering>() - 2608usize];
    ["Alignment of ec_ering"][::std::mem::align_of::<ec_ering>() - 8usize];
    ...
    ["Offset of field: ec_ering::Error"][::std::mem::offset_of!(ec_ering, Error) - 8usize];
};
#[doc = " ringbuf for error storage"]
...
pub struct ecx_context {
    #[doc = " port, may include red_port"]
    pub port: ecx_portt,
    #[doc = " list of detected slaves"]
    pub slavelist: [ec_slavet; 200usize],
    #[doc = " number of slaves found in configuration"]
    pub slavecount: ::std::os::raw::c_int,
    #[doc = " list of groups"]
    pub grouplist: [ec_groupt; 2usize],
    #[doc = " ecaterror state"]
    pub ecaterror: boolean,
    #[doc = " last DC time from slaves"]
    pub DCtime: int64,
    #[doc = " internal, eeprom cache buffer"]
    pub esibuf: [uint8; 4096usize],
    #[doc = " internal, eeprom cache map"]
    pub esimap: [uint32; 128usize],
    #[doc = " internal, current slave for eeprom cache"]
    pub esislave: uint16,
    #[doc = " internal, error list"]
    pub elist: ec_eringt,
    #[doc = " internal, processdata stack buffer info"]
    pub idxstack: ec_idxstackT,
    #[doc = " internal, SM buffer"]
    pub SMcommtype: [ec_SMcommtypet; 1usize],
    #[doc = " internal, PDO assign list"]
    pub PDOassign: [ec_PDOassignt; 1usize],
    #[doc = " internal, PDO description list"]
    pub PDOdesc: [ec_PDOdesct; 1usize],
    #[doc = " internal, SM list from eeprom"]
    pub eepSM: ec_eepromSMt,
    #[doc = " internal, FMMU list from eeprom"]
    pub eepFMMU: ec_eepromFMMUt,
    #[doc = " internal, mailbox pool"]
    pub mbxpool: ec_mbxpoolt,
    #[doc = " network information hook"]
    pub ENI: *mut ec_enit,
    ...
    #[doc = " opaque pointer to application userdata, never used by SOEM."]
    pub userdata: *mut ::std::os::raw::c_void,
    #[doc = " In overlapped mode, inputs will replace outputs in the incoming\n frame. Use this mode for TI ESC:s. Processdata is always aligned\n on a byte boundary."]
    pub overlappedMode: boolean,
    #[doc = " Do not map each slave on a byte boundary. May result in smaller\n frame sizes. Has no effect in overlapped mode."]
    pub packedMode: boolean,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ecx_context"][::std::mem::size_of::<ecx_context>() - 204576usize];
    ...
    ["Offset of field: ecx_context::slavelist"]
        [::std::mem::offset_of!(ecx_context, slavelist) - 52024usize];
    ["Offset of field: ecx_context::slavecount"]
        [::std::mem::offset_of!(ecx_context, slavecount) - 144824usize];
    ["Offset of field: ecx_context::grouplist"]
        [::std::mem::offset_of!(ecx_context, grouplist) - 144832usize];
    ["Offset of field: ecx_context::ecaterror"]
        [::std::mem::offset_of!(ecx_context, ecaterror) - 147744usize];
    ["Offset of field: ecx_context::DCtime"]
        [::std::mem::offset_of!(ecx_context, DCtime) - 147752usize];
    ["Offset of field: ecx_context::esibuf"]
        [::std::mem::offset_of!(ecx_context, esibuf) - 147760usize];
    ["Offset of field: ecx_context::esimap"]
        [::std::mem::offset_of!(ecx_context, esimap) - 151856usize];
    ["Offset of field: ecx_context::esislave"]
        [::std::mem::offset_of!(ecx_context, esislave) - 152368usize];
    ["Offset of field: ecx_context::elist"]
        [::std::mem::offset_of!(ecx_context, elist) - 152376usize];
    ["Offset of field: ecx_context::idxstack"]
        [::std::mem::offset_of!(ecx_context, idxstack) - 154984usize];
    ["Offset of field: ecx_context::SMcommtype"]
        [::std::mem::offset_of!(ecx_context, SMcommtype) - 155216usize];
    ["Offset of field: ecx_context::PDOassign"]
        [::std::mem::offset_of!(ecx_context, PDOassign) - 155226usize];
    ["Offset of field: ecx_context::PDOdesc"]
        [::std::mem::offset_of!(ecx_context, PDOdesc) - 155740usize];
    ["Offset of field: ecx_context::eepSM"]
        [::std::mem::offset_of!(ecx_context, eepSM) - 156766usize];
    ["Offset of field: ecx_context::eepFMMU"]
        [::std::mem::offset_of!(ecx_context, eepFMMU) - 156778usize];
    ["Offset of field: ecx_context::mbxpool"]
        [::std::mem::offset_of!(ecx_context, mbxpool) - 156792usize];
    ["Offset of field: ecx_context::ENI"][::std::mem::offset_of!(ecx_context, ENI) - 204528usize];
    ["Offset of field: ecx_context::FOEhook"]
        [::std::mem::offset_of!(ecx_context, FOEhook) - 204536usize];
    ["Offset of field: ecx_context::EOEhook"]
        [::std::mem::offset_of!(ecx_context, EOEhook) - 204544usize];
    ["Offset of field: ecx_context::manualstatechange"]
        [::std::mem::offset_of!(ecx_context, manualstatechange) - 204552usize];
    ["Offset of field: ecx_context::userdata"]
        [::std::mem::offset_of!(ecx_context, userdata) - 204560usize];
    ["Offset of field: ecx_context::overlappedMode"]
        [::std::mem::offset_of!(ecx_context, overlappedMode) - 204568usize];
    ["Offset of field: ecx_context::packedMode"]
        [::std::mem::offset_of!(ecx_context, packedMode) - 204569usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn ecx_mbxreceive(
        context: *mut ecx_contextt,
        slave: uint16,
        mbx: *mut *mut ec_mbxbuft,
        timeout: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn ecx_mbxENIinitcmds(
        context: *mut ecx_contextt,
        slave: uint16,
        transition: u16,
    ) -> ::std::os::raw::c_int;
...
unsafe extern "C" {
    pub fn ecx_getmbx(context: *mut ecx_contextt) -> *mut ec_mbxbuft;
}
unsafe extern "C" {
    pub fn ecx_dropmbx(context: *mut ecx_contextt, mbx: *mut ec_mbxbuft) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn ecx_initmbxpool(context: *mut ecx_contextt) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn ecx_initmbxqueue(context: *mut ecx_contextt, group: uint8) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn ecx_slavembxcyclic(context: *mut ecx_contextt, slave: uint16) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn ecx_config_init(context: *mut ecx_contextt) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn ec_sdoerror2string(sdoerrorcode: uint32) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
